                ...
                if (!$queryResult) {
                    ...
                    while ($row = mysqli_fetch_assoc($queryResult)) {
                        ...
                        <tr>
                            ...
                            <td><a href="deletebuilding.php?buildingid=<?php echo $row['buildingID']; ?>" onclick="return confirmDelete()">Delete</a></td>
                        </tr>
                        <?php
                    }
                }
...
function confirmDelete() {
    return confirm("Are you sure you want to delete this building?");
}
</script>
